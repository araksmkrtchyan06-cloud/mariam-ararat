...
function changeLanguage(lang) {
    ...
    if (side) {
        ...
        const currentValue = side.value;

        if (currentValue === "Հարսի կողմ" ||
            currentValue === "Со стороны невесты") {

            side.value = translations[lang].brideSide;

        }

        else if (currentValue === "Փեսայի կողմ" ||
                 currentValue === "Со стороны жениха") {

            side.value = translations[lang].groomSide;
